...
class StepLrUpdaterHookEstimator(LrUpdaterHook):
    ...
    def __init__(self, step, gamma=0.1, **kwargs):
        ...
        self.step = step
        self.gamma = gamma
        super(StepLrUpdaterHookEstimator, self).__init__(**kwargs)

    def get_lr(self, runner, base_lr):
        if runner.model.module.decay:
            runner.model.module.decay = False
