...
class BBoxTestMixin(object):
    ...
    def simple_test_bboxes(self,
        ...
        cls_score, bbox_pred = self.bbox_head(roi_feats, rois=rois, scale_factor=scale_factor)
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        for x, img_meta in zip(feats, img_metas):
            ...
            if self.with_shared_head:
                roi_feats = self.shared_head(roi_feats)
            cls_score, bbox_pred = self.bbox_head(roi_feats, rois=rois)
...
class MaskTestMixin(object):
    ...
    def simple_test_mask(self,
        ...
        if det_bboxes.shape[0] == 0:
            ...
            mask_pred = self.mask_head(mask_feats, rois=mask_rois, scale_factor=scale_factor)
            segm_result = self.mask_head.get_seg_masks(
                mask_pred, _bboxes, det_labels, self.test_cfg.rcnn, ori_shape,
                scale_factor, window, rescale, encode=encode)
        return segm_result
