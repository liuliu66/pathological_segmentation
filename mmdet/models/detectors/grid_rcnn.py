...
class GridRCNN(TwoStageDetector):
    ...
    def forward_train(self,
        ...
        if self.with_bbox:
            ...
            if isinstance(grid_feats, list):
                sample_idx = torch.randperm(
                    grid_feats[0].shape[0])[:min(grid_feats[0].
                                              shape[0], max_sample_num_grid)]
                grid_feats = [grid_feats[i][sample_idx] for i in range(len(grid_feats))]
            else:
                sample_idx = torch.randperm(
            ...
            grid_pred = self.grid_head(grid_feats, pos_rois=pos_rois[sample_idx], scale_factor=scale_factor)
    ...
    def simple_test(self, img, img_meta, proposals=None, rescale=False):
        ...
        if grid_rois.shape[0] != 0:
            ...
            scale_factor = img_meta[0]['scale_factor']
            grid_pred = self.grid_head(grid_feats, pos_rois=grid_rois, scale_factor=scale_factor)
